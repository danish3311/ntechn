...
<div class="woocommerce-pagination-wrap">
    <?php
    if ($total >= 1) {
        $pagination = priotech_get_theme_option('woocommerce_shop_pagination', 'default');
        $pagination_text = esc_html__('Load more','priotech');
        if ('infinit' == $pagination) :
            $pagination_text = esc_html__('Loading...','priotech');
            wp_enqueue_script('priotech-waypoints');
        endif;
                ...
                echo paginate_links(
                    apply_filters(
                        ...
                        array( // WPCS: XSS ok.
                               ...
                               'total'     => $total,
                               'prev_text' => esc_html__('Prev', 'priotech'),
                               'next_text' => esc_html__('Next', 'priotech'),
                               'type'      => 'list',
                               'end_size'  => 3,
                               'mid_size'  => 3
                        )
