...
class Priotech_breadcrumb {
	...
	private function __construct() {
		...
		add_filter('priotech_page_title', [$this, 'hide_title']);
	...
	public function breadcrumb_register() {
		$labels = [
			'name'               => esc_html__('Breadcrumbs', 'priotech'),
			'singular_name'      => esc_html__('Breadcrumb', 'priotech'),
			'menu_name'          => esc_html__('Breadcrumbs', 'priotech'),
			'name_admin_bar'     => esc_html__('Breadcrumb', 'priotech'),
			'add_new'            => esc_html__('Add New', 'priotech'),
			'add_new_item'       => esc_html__('Add New Breadcrumb', 'priotech'),
			'new_item'           => esc_html__('New Header Footer & Blocks Template', 'priotech'),
			'edit_item'          => esc_html__('Edit Header Footer & Blocks Template', 'priotech'),
			'view_item'          => esc_html__('View Header Footer & Blocks Template', 'priotech'),
			'all_items'          => esc_html__('All Breadcrumb', 'priotech'),
			'search_items'       => esc_html__('Search Header Footer & Blocks Templates', 'priotech'),
			'parent_item_colon'  => esc_html__('Parent Header Footer & Blocks Templates:', 'priotech'),
			'not_found'          => esc_html__('No Header Footer & Blocks Templates found.', 'priotech'),
			'not_found_in_trash' => esc_html__('No Header Footer & Blocks Templates found in Trash.', 'priotech'),
		];
		...
		register_post_type('priotech-breadcrumb', $args);
	}
	...
	public function register_admin_menu() {
		add_submenu_page(
			'themes.php',
			esc_html__('Breadcrumbs', 'priotech'),
			esc_html__('Breadcrumbs', 'priotech'),
			'edit_pages',
			'edit.php?post_type=priotech-breadcrumb'
		);
	}
	...
	function ehf_register_metabox() {
		add_meta_box(
			'ehf-meta-box',
			esc_html__('Breadcrumb Options', 'priotech'),
			[
				$this,
				'efh_metabox_render',
			],
		...
		<table class="hfe-options-table widefat">
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Display On', 'priotech'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should appear.', 'priotech'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					...
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Display Rules', 'priotech'),
							'value'          => '[{"type":"basic-global","specific":null}]',
							'tags'           => 'site,enable,target,pages',
							'rule_type'      => 'display',
							'add_rule_label' => esc_html__('Add Display Rule', 'priotech'),
						],
						$include_locations
					);
					?>
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Do Not Display On', 'priotech'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should not appear.', 'priotech'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Exclude On', 'priotech'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add Exclusion Rule', 'priotech'),
							'rule_type'      => 'exclude',
						],
						$exclude_locations
					);
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('User Roles', 'priotech'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help" title="<?php echo esc_attr__('Display custom template based on user role.', 'priotech'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_user_role_settings_field(
						...
						[
							'title'          => esc_html__('Users', 'priotech'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add User Rule', 'priotech'),
						],
						$users
					);
					?>
	...
	public static function get_template_id() {
		...
		$hfe_templates = Astra_Target_Rules_Fields::get_instance()->get_posts_by_conditions('priotech-breadcrumb', $option);
	...
	public function block_template_frontend() {
		if (is_singular('priotech-breadcrumb') && !current_user_can('edit_posts')) {
	...
	function load_canvas_template($single_template) {
		...
		if ('priotech-breadcrumb' == $post->post_type) {
