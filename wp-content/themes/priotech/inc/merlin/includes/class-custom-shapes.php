...
/**
 * Class Priotech_Elementor_Custom_Shapes
 *
 * Main Plugin class
 * @since 0.0.1
 */
class Priotech_Elementor_Custom_Shapes {
    ...
    public function ecs_register_cpt() {
        ...
        $labels = array(
            'name'                  => _x('Custom shapes', 'Post Type General Name', 'priotech'),
            'singular_name'         => _x('Custom shape', 'Post Type Singular Name', 'priotech'),
            'menu_name'             => __('Custom shapes', 'priotech'),
            'name_admin_bar'        => __('Custom shape', 'priotech'),
            'archives'              => __('Item Archives', 'priotech'),
            'attributes'            => __('Item Attributes', 'priotech'),
            'parent_item_colon'     => __('Parent Item:', 'priotech'),
            'all_items'             => __('All Items', 'priotech'),
            'add_new_item'          => __('Add New Item', 'priotech'),
            'add_new'               => __('Add New', 'priotech'),
            'new_item'              => __('New Item', 'priotech'),
            'edit_item'             => __('Edit Item', 'priotech'),
            'update_item'           => __('Update Item', 'priotech'),
            'view_item'             => __('View Item', 'priotech'),
            'view_items'            => __('View Items', 'priotech'),
            'search_items'          => __('Search Item', 'priotech'),
            'not_found'             => __('Not found', 'priotech'),
            'not_found_in_trash'    => __('Not found in Trash', 'priotech'),
            'featured_image'        => __('Featured Image', 'priotech'),
            'set_featured_image'    => __('Set featured image', 'priotech'),
            'remove_featured_image' => __('Remove featured image', 'priotech'),
            'use_featured_image'    => __('Use as featured image', 'priotech'),
            'insert_into_item'      => __('Insert into item', 'priotech'),
            'uploaded_to_this_item' => __('Uploaded to this item', 'priotech'),
            'items_list'            => __('Items list', 'priotech'),
            'items_list_navigation' => __('Items list navigation', 'priotech'),
            'filter_items_list'     => __('Filter items list', 'priotech'),
        );
        $args   = array(
            'label'               => __('Custom shape', 'priotech'),
            'description'         => __('Custom shapes', 'priotech'),
            'labels'              => $labels,
    ...
    public function ecs_register_admin_menu() {
        $menu_title = _x('Custom Shapes', 'Elementor Custom Shapes', 'priotech');
        add_submenu_page(
            'elementor',
            $menu_title,
            $menu_title,
...
Priotech_Elementor_Custom_Shapes::instance();