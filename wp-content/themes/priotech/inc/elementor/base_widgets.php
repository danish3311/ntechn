...
abstract class Priotech_Base_Widgets extends Widget_Base {
    /**
    ...
    protected function get_controls_column($condition = false) {
        ...
        $args_column = [
            'label' => esc_html__('Column Options', 'priotech')
        ];
        if ($condition) {
        ...
        $this->add_responsive_control(
            'column',
            [
                'label'              => esc_html__('Columns', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Column Spacing', 'priotech'),
     ...
     * @access protected
     */
    protected function get_control_carousel($condition = false) {
     ...
     * @access protected
     */
    protected function get_control_carousel_options($condition = false) {
        $args_caroseul_section = [
            'label' => esc_html__('Caroseul Options', 'priotech'),
        ];
        if ($condition) {
        ...
        $this->add_control(
            'enable_carousel',
            [
                'label' => esc_html__('Enable Carousel', 'priotech'),
        ...
        $this->add_control(
            'swiper_overflow',
            [
                'label'              => esc_html__('Overflow', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'none',
                'options'            => [
                    'none'  => esc_html__('None', 'priotech'),
                    'left'  => esc_html__('Overflow to the left', 'priotech'),
                    'right' => esc_html__('Overflow to the right', 'priotech'),
                ],
                'frontend_available' => true,
        ...
        $this->add_control(
            'navigation',
            [
                'label'              => esc_html__('Navigation', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'both',
                'options'            => [
                    'both'   => esc_html__('Arrows and Dots', 'priotech'),
                    'arrows' => esc_html__('Arrows', 'priotech'),
                    'dots'   => esc_html__('Dots', 'priotech'),
                    'none'   => esc_html__('None', 'priotech'),
                ],
                'frontend_available' => true,
                'condition'          => [
        ...
        $this->add_control('custom_navigation',
            [
                'label'              => esc_html__('Custom Navigation', 'priotech'),
                'type'               => Controls_Manager::SWITCHER,
                'frontend_available' => true,
                'conditions'         => [
                    'relation' => 'and',
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Class Navigation Previous', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Class Navigation Next', 'priotech'),
                'type'               => Controls_Manager::TEXT,
                'frontend_available' => true,
                'conditions'         => [
                    'relation' => 'and',
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Previous Arrow Icon', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Next Arrow Icon', 'priotech'),
                'type'             => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
                'skin'             => 'inline',
                'label_block'      => false,
    ...
    protected function get_control_carousel_additional($condition = false) {
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Additional Options', 'priotech'),
        ...
        $this->add_control(
            'lazyload',
            [
                'label'              => esc_html__('Lazyload', 'priotech'),
                'type'               => Controls_Manager::SWITCHER,
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'autoplay',
            [
                'label'              => esc_html__('Autoplay', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'priotech'),
                    'no'  => esc_html__('No', 'priotech'),
                ],
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'              => esc_html__('Pause on Hover', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Pause on Interaction', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'priotech'),
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label'              => esc_html__('Autoplay Speed', 'priotech'),
        ...
        $this->add_control(
            'infinite',
            [
                'label'              => esc_html__('Infinite Loop', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'priotech'),
        ...
        $this->add_control(
            'effect',
            [
                'label'              => esc_html__('Effect', 'priotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'slide',
                'options'            => [
                    'slide' => esc_html__('Slide', 'priotech'),
        ...
        $this->add_control(
            'speed',
            [
                'label'              => esc_html__('Animation Speed', 'priotech'),
                'type'               => Controls_Manager::NUMBER,
                'default'            => 500,
                'render_type'        => 'none',
                'frontend_available' => true,
        ...
        $this->add_control(
            'direction',
            [
                'label'   => esc_html__('Direction', 'priotech'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'ltr',
                'options' => [
                    'ltr' => esc_html__('Left', 'priotech'),
                    'rtl' => esc_html__('Right', 'priotech'),
                ],
            ]
        );
    ...
    protected function get_control_carousel_style_navigation($condition = false) {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Arrows', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .priotech-swiper-wrapper .elementor-swiper-button i' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'navigation' => ['arrows', 'both'],
                ],
        ...
        $this->add_control(
            'arrows_next_heading',
            [
                'label'     => esc_html__('Next button', 'priotech'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'navigation' => ['arrows', 'both'],
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Next Vertical', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Next Horizontal', 'priotech'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'options'      => [
                    'left'  => [
        ...
        $this->add_control(
            'arrows_prev_heading',
            [
                'label'     => esc_html__('Prev button', 'priotech'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'navigation' => ['arrows', 'both'],
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Prev Vertical', 'priotech'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'render_type'  => 'ui',
                'options'      => [
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Prev Horizontal', 'priotech'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'options'      => [
                    'left'  => [
        ...
        $this->add_control(
            'heading_style_dots',
            [
                'label'     => esc_html__('Pagination', 'priotech'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
        ...
        $this->add_control(
            'dots_position',
            [
                'label'        => esc_html__('Position', 'priotech'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'outside',
                'options'      => [
                    'outside' => esc_html__('Outside', 'priotech'),
                    'inside'  => esc_html__('Inside', 'priotech'),
                ],
        ...
        $this->add_control(
            'dots_color',
            [
                'label'     => esc_html__('Active Color', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'carousel_dots',
            [
                'label'      => esc_html__('Carousel Dots', 'priotech'),
        ...
        $this->add_control(
            'style_dot',
            [
                'label'        => esc_html__('Style Dot', 'priotech'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'style-1' => esc_html__('Style 1', 'priotech'),
                    'style-2' => esc_html__('Style 2', 'priotech'),
                    'style-3' => esc_html__('Style 3', 'priotech'),
                ],
                'default'      => 'style-1',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Hover', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__('Activate', 'priotech'),
            ]
        );
        ...
        $this->add_responsive_control(
            'dots_vertical_value',
            [
                'label'      => esc_html__('Spacing', 'priotech'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'Alignment_text',
            [
                'label'     => esc_html__('Alignment text', 'priotech'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'left'   => [
                        'title' => esc_html__('Left', 'priotech'),
    ...
    protected function get_swiper_navigation_for_product() {
        ...
        if ($show_arrows && $settings['custom_navigation'] != 'yes') {
            ...
            $settings_navigation .= '<span class="elementor-screen-only">' . esc_html__('Previous', 'priotech') . '</span>';
            ...
            $settings_navigation .= '<span class="elementor-screen-only">' . esc_html__('Next', 'priotech') . '</span>';
            $settings_navigation .= '</div>';
        }
    ...
    protected function get_data_elementor_columns() {
        ...
        $settings = $this->get_settings_for_display();
        //item
        $this->add_render_attribute('wrapper', 'class', 'priotech-wrapper');
        $this->add_render_attribute('container', 'class', 'priotech-con');
        $this->add_render_attribute('inner', 'class', 'priotech-con-inner');
        if ($settings['enable_carousel'] === 'yes') {
            $swiper_class = Plugin::$instance->experiments->is_feature_active('e_swiper_latest') ? 'swiper' : 'swiper-container';
            $this->add_render_attribute('wrapper', 'class', 'priotech-swiper-wrapper swiper');
            $this->add_render_attribute('container', 'class', [$swiper_class, 'priotech-swiper']);
    ...
    protected function get_control_pagination() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'priotech'),
                    'prev_next'             => esc_html__('Previous/Next', 'priotech'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'priotech') . ' + ' . esc_html__('Previous/Next', 'priotech'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'priotech'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'priotech'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'condition' => [
                    'pagination_type' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'priotech'),
                'default'   => esc_html__('&laquo; Previous', 'priotech'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'priotech'),
                'default'   => esc_html__('Next &raquo;', 'priotech'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'priotech') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" aria-label="<?php esc_attr_e('Pagination', 'priotech'); ?>">
