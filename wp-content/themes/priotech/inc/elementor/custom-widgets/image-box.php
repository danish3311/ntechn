...
add_action('elementor/element/image-box/section_image/before_section_end', function ($element, $args) {
    ...
    $element->add_responsive_control(
       'button_spacing',
       [
           'label'     => esc_html__('Spacing Button', 'priotech'),
...
add_action('elementor/element/image-box/section_style_image/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Color Title Hover', 'priotech'),
...
class Priotech_Elementor_Image_Box extends Widget_Image_Box {
    /**
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_image',
			[
				'label' => esc_html__( 'Image Box', 'priotech' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'This is the heading', 'priotech' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => esc_html__( 'This is the subtitle', 'priotech' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'priotech' ),
        ...
        $this->add_control(
            'subtitle_position',
            [
                'label'   => esc_html__('SubTitle Position', 'priotech'),
		...
		$this->add_control(
			'position',
			[
				'label' => esc_html__( 'Image Position', 'priotech' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'options' => [
					'left' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Vertical Alignment', 'priotech' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'top' => [
						'title' => esc_html__( 'Top', 'priotech' ),
        ...
        if ($has_content) {
            ...
            if (!empty($settings['link']['url'])) {
                if ($settings['image_show_button']) {
                    ...
                    <i class="priotech-icon-angle-right"></i></span></a></div>');
                }
            }
...
$widgets_manager->register(new Priotech_Elementor_Image_Box());
