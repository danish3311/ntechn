...
add_action( 'elementor/element/icon-box/section_icon/after_section_end', function ($element, $args ) {
    ...
    $element->update_control( 'shape', [
        'options' => [
            ...
            'dashed-circle' => esc_html__( 'Dashed Circle', 'priotech' ),
        ],
    ] );
...
add_action('elementor/element/icon-box/section_icon/before_section_end', function ($element, $args) {
    $element->add_control(
        'background_deco',
        [
            'label'     => esc_html__('Background Deco', 'priotech'),
...
add_action('elementor/element/icon-box/section_icon/after_section_end', function ($element, $args) {
	...
	$element->add_responsive_control(
		'divider_horizontal',
		[
			'label' => esc_html__( 'Divider Horizontal', 'priotech' ),
	...
	$element->add_responsive_control(
		'divider_vertical',
		[
			'label' => esc_html__( 'Divider Vertical', 'priotech' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'top',
			'options' => [
				'top' => [
	...
	$element->add_responsive_control(
        'divider_width',
        [
			'label' => esc_html__( 'Divider Width', 'priotech' ),
	...
	$element->add_responsive_control(
        'divider_height',
        [
			'label' => esc_html__( 'Divider Height', 'priotech' ),
            'type'       => Controls_Manager::SLIDER,
			'size_units' => ['px', 'em', '%'],
			'selectors'  => [
	...
	$element->add_responsive_control(
        'divider_color',
        [
			'label' => esc_html__( 'Divider Color', 'priotech' ),
...
add_action('elementor/element/icon-box/section_icon/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Effects Hover', 'priotech'),
            'type'      => Controls_Manager::SWITCHER,
            'prefix_class' => 'effects-background-deco-',
            'condition'   => [
                'background_deco' => 'yes'
            ],
        ]
...
add_action('elementor/element/icon-box/section_style_content/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Title Margin', 'priotech'),
...
add_action('elementor/element/icon-box/section_style_content/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Description Margin', 'priotech'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', 'em'],
            'selectors' => [
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
	...
	$element->add_control(
		...
		[
			'label' => esc_html__( 'Hover Border Color', 'priotech' ),
			'type' => Controls_Manager::COLOR,
			'global' => [
				'default' => Global_Colors::COLOR_PRIMARY,
			],
...
add_action('elementor/element/icon-box/section_style_icon/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        'effect_bg_color',
        [
            'label' => esc_html__('Effect Background Color', 'priotech'),
            'type' => Controls_Manager::COLOR,
			'default'   => '',
            'selectors' => [
                '{{WRAPPER}}.background-deco-yes .elementor-icon::before' => 'background-color: {{VALUE}};',
            ],
            'separator' => 'before',
            'condition'   => [
                'background_deco' => 'yes'
...
class Priotech_Elementor_Icon_Box extends Widget_Icon_Box {

    public function get_script_depends() {
        return ['priotech-elementor-icon-box'];
    }
...
$widgets_manager->register(new Priotech_Elementor_Icon_Box());
