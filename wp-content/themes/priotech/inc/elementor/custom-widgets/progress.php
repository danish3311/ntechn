...
add_action('elementor/element/progress/section_progress_style/before_section_end', function ($element, $args) {
    $element->add_control(
        'bar_border_radius1',
        [
            'label'      => esc_html__('Progress Done Border Radius ', 'priotech'),
...
add_action('elementor/element/progress/section_progress_style/before_section_end', function ($element, $args) {
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__('Progress bar padding', 'priotech'),
...
add_action('elementor/element/progress/section_title/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Percentage Text', 'priotech'),
...
add_action('elementor/element/progress/section_title/before_section_end', function ($element, $args) {
    $element->add_control(
        ...
        [
            'label'     => esc_html__('Percentage Color', 'priotech'),
...
class Priotech_Elementor_Progress extends Widget_Progress {
    /**
...
$widgets_manager->register(new Priotech_Elementor_Progress());
