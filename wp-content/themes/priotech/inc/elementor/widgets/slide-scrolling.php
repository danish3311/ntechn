 ...
 * @since 1.0.0
 */
class Priotech_Elementor_Slide_Scrolling extends Priotech_Base_Widgets {
    ...
    public function get_name() {
        return 'priotech-slide-scrolling';
    }
    ...
    public function get_title() {
        return esc_html__('Priotech Slide Scrolling', 'priotech');
    }
    /**
     * Get widget icon.
     *
    ...
    public function get_script_depends() {
        return ['priotech-elementor-slide-scrolling','tweenmax'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'scrolling_title',
            [
                'label'       => esc_html__('Scrolling name', 'priotech'),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Scrolling Name', 'priotech'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'border_style',
            [
                'label'        => esc_html__('Border', 'priotech'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
                'prefix_class' => 'priotech-scrolling-border-'
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Item', 'priotech'),
...
$widgets_manager->register(new Priotech_Elementor_Slide_Scrolling());
