 ...
 * @since 1.0.0
 */
class Priotech_Elementor_Widget_Products_Recently extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'priotech-products-recently';
    }
    ...
    public function get_title() {
        return esc_html__('Products Recently', 'priotech');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'product_gutter',
            [
                'label'      => esc_html__('Gutter', 'priotech'),
    ...
    protected function render() {
        ...
        if (empty($viewed_products)) {
            echo '<p class="recently-notice">' . esc_html__('There’s no item that you viewed recently.', 'priotech') . '</p>';
            return;
        }
...
$widgets_manager->register(new Priotech_Elementor_Widget_Products_Recently());
