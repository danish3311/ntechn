...
class Priotech_Video_Popup extends Elementor\Widget_Base {


    public function get_name() {
        return 'priotech-video-popup';
    }

    public function get_title() {
        return esc_html__('Priotech Video Popup', 'priotech');
    }
    ...
    public function get_script_depends() {
        return ['priotech-elementor-video', 'magnific-popup'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__('Support video from Youtube and Vimeo', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Tile', 'priotech'),
                'default'     => '',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Description', 'priotech'),
                'default'     => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'after',
                'options' => [
                    'before' => esc_html__( 'Before', 'priotech' ),
                    'after' => esc_html__( 'After', 'priotech' ),
                ],
                'condition' => [
                    'video_icon[value]!' => '',
                ],
        ...
        $this->add_control(
            'show_title_block',
            [
                'label'     => esc_html__('Position Vertical', 'priotech'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-popup' => 'flex-direction: column; text-align: center;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'video_size',
            [
                'label'     => esc_html__('Font Size', 'priotech'),
                ...
                'selectors' => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-icon ' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .priotech-video-popup:hover .elementor-video-icon',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .priotech-video-popup .elementor-video-icon',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-title' => 'color: {{VALUE}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .priotech-video-popup .elementor-video-title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .priotech-video-popup .elementor-video-description' => 'color: {{VALUE}};',
        ...
        $this->add_group_control(
            ...
            [
                ...
                //'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .priotech-video-popup .elementor-video-description',
            ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute('wrapper', 'class', 'priotech-video-popup');
...
$widgets_manager->register(new Priotech_Video_Popup());
