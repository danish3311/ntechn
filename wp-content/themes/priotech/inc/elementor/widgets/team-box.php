...
class Priotech_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'priotech');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_team',
            [
                'label' => esc_html__('Team', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'priotech'),
        ...
        $this->add_control(
            'facebook',
            [
                'label'       => esc_html__('Facebook', 'priotech'),
                'placeholder' => esc_html__('https://www.facebook.com/themelexus', 'priotech'),
        ...
        $this->add_control(
            'twitter',
            [
                'label'       => esc_html__('Twitter', 'priotech'),
                'placeholder' => esc_html__('https://twitter.com/themelexus', 'priotech'),
        ...
        $this->add_control(
            'pinterest',
            [
                'label'       => esc_html__('Pinterest', 'priotech'),
                'placeholder' => esc_html__('https://www.pinterest.com/', 'priotech'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => esc_html__('Youtube', 'priotech'),
                'placeholder' => esc_html__('https://www.youtube.com/', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .image-content:before'     => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'priotech'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                    ...
                    <?php if (!empty($settings[$key])) : ?>
                        <li class="social">
                            <a href="<?php echo esc_url($settings[$key]) ?>">
                                <i class="priotech-icon-<?php echo esc_attr($social); ?>"></i>
                            </a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
...
$widgets_manager->register(new Priotech_Elementor_Team_Box());
