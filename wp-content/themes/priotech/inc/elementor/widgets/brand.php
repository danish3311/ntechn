 ...
 * @since 1.0.0
 */
class Priotech_Elementor_Brand extends Priotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Brands', 'priotech');
    }
    ...
    public function get_script_depends() {
        return ['priotech-elementor-brand'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'priotech'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'priotech'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'priotech'),
                'placeholder' => esc_html__('Brand Name', 'priotech'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => '',
                'prefix_class' => 'priotech-brand-border-'
            ]
        );
...
$widgets_manager->register(new Priotech_Elementor_Brand());
