...
class Priotech_Call_To_Action extends Elementor\Widget_Base {

    public function get_name() {
        return 'priotech-banner';
    }

    public function get_title() {
        return esc_html__('Priotech Banner', 'priotech');
    }
    ...
    protected function register_controls( $args = [] ) {
        ...
        $default_args = [
            'section_condition' => [],
            'button_default_text' => esc_html__( 'Click here', 'priotech' ),
            'text_control_label' => esc_html__( 'Text', 'priotech' ),
        ...
        $this->add_control(
            'bg_image',
            [
                'label'   => esc_html__('Choose Background Image', 'priotech'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Image Resolution', 'priotech'),
                'default'   => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('This is the sub title', 'priotech'),
                'placeholder' => esc_html__('Enter your sub title', 'priotech'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'sub_title_position',
            [
                'label'        => __('Position Sub Title', 'priotech'),
        ...
        $this->add_control(
            'title',
            [
                'label'       => esc_html__('Heading 1', 'priotech'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 1', 'priotech'),
                'placeholder' => esc_html__('Enter your heading 1', 'priotech'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            'heading2',
            [
                'label'       => esc_html__('Heading 2', 'priotech'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => [
                    'active' => true,
                ],
                'default'     => esc_html__('This is the heading 2', 'priotech'),
                'placeholder' => esc_html__('Enter your heading 2', 'priotech'),
                'label_block' => true,
                'separator'   => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'priotech'),
                'placeholder' => esc_html__('Enter your description', 'priotech'),
                'separator'   => 'none',
                'rows'        => 5,
            ]
        );
        ...
        $this->add_control(
            'link_click',
            [
                'label'     => esc_html__('Apply Link On', 'priotech'),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'box'    => esc_html__('Whole Box', 'priotech'),
                    'button' => esc_html__('Button Only', 'priotech'),
                ],
                'default'   => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label'        => esc_html__('Stretch', 'priotech'),
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label'     => esc_html__('Horizontal Align', 'priotech'),
                ...
                'default'   => 'flex-start',
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-priotech-banner.box-align-left .elementor-cta .elementor-cta__content' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'inner_padding',
            [
                'label'      => esc_html__('Padding Content', 'priotech'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em'],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Content', 'priotech'),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'      => '',
                'selectors'    => [
                    '{{WRAPPER}}.elementor-widget-priotech-banner.box-align-center .elementor-cta .elementor-cta__content' => 'text-align: {{VALUE}}',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'label'     => esc_html__('Heading', 'priotech'),
                'separator' => 'before',
                'condition' => [
                    'title!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Enable Effect', 'priotech'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'type'      => Controls_Manager::HEADING,
                'label'     => esc_html__('Colors', 'priotech'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'title_color',
            [
                'label'     => esc_html__('Heading Color', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'heading2_color',
            [
                'label'     => esc_html__('Heading2 Color', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label'     => esc_html__('Sub title Color', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label'     => esc_html__('Description Color', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'default',
                'prefix_class' => 'button-banner-style-priotech-',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Position Bottom', 'priotech'),
                'type'         => Controls_Manager::SWITCHER,
                'condition'    => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Box Text Color', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__('Hover Effects', 'priotech'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type'  => Controls_Manager::HEADING,
                'label' => esc_html__('Background', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            'transformation',
            [
                'label'        => esc_html__('Hover Animation', 'priotech'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    ''                  => 'None',
                    'zoom-in'           => 'Zoom In',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'       => '{{WRAPPER}}.elementor-widget-priotech-banner:not(:hover) .elementor-cta__bg-overlay',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}}.elementor-widget-priotech-banner:hover .elementor-cta__bg',
            ]
        );
        ...
        $this->add_control(
            'effect_duration',
            [
                'label'       => esc_html__('Transition Duration', 'priotech'),
                'type'        => Controls_Manager::SLIDER,
...
$widgets_manager->register(new Priotech_Call_To_Action());
