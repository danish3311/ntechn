...
class Priotech_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'priotech-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Priotech Vertical Menu', 'priotech');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'priotech'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Dropdown', 'priotech'),
                    'style-2' => esc_html__('Navbar', 'priotech'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .priotech-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'priotech'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .priotech-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control('vertical_menu_separator', [
            'label' => esc_html__('Separator', 'priotech'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'priotech'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'priotech'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'priotech'); ?>">
...
$widgets_manager->register(new Priotech_Elementor_Vertiacl_Menu());
