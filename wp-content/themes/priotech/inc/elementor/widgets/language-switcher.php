 ...
 * @since 1.0.0
 */
class Priotech_Elementor_Language_Switcher extends Elementor\Widget_Base
{
    ...
    {
        return 'priotech-language-switcher';
    }
    ...
    {
        return esc_html__('Language Switcher', 'priotech');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .priotech-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label' => esc_html__('Label Color', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .priotech-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label' => esc_html__('Hover Right', 'priotech'),
    ...
    {
        priotech_language_switcher();
    }
}

$widgets_manager->register(new Priotech_Elementor_Language_Switcher());
