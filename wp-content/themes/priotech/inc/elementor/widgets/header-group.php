...
class Priotech_Elementor_Header_Group extends Elementor\Widget_Base {

    public function get_name() {
        return 'priotech-header-group';
    }

    public function get_title() {
        return esc_html__('Priotech Header Group', 'priotech');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_search',
            [
                'label' => esc_html__('Show search', 'priotech'),
        ...
        $this->add_control(
            'show_account',
            [
                'label' => esc_html__('Show account', 'priotech'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_wishlist',
            [
                'label' => esc_html__('Show wishlist', 'priotech'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_cart',
            [
                'label' => esc_html__('Show cart', 'priotech'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
    ...
    protected function render() {
        ...
        <div <?php $this->print_render_attribute_string('wrapper'); ?>>
            <div class="header-group-action">
                ...
                <?php if ($settings['show_wishlist'] === 'yes' && priotech_is_woocommerce_activated()):{
                    priotech_header_wishlist();
                }
                endif; ?>

                <?php if ($settings['show_cart'] === 'yes' && priotech_is_woocommerce_activated()):{
...
$widgets_manager->register(new Priotech_Elementor_Header_Group());
