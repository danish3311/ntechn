...
class Priotech_Pricing extends Elementor\Widget_Base {

    public function get_name() {
        return 'priotech-pricing';
    }

    public function get_title() {
        return esc_html__('Priotech Pricing', 'priotech');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_header',
            [
                'label' => esc_html__('Header', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Enter your title', 'priotech'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            'sub_heading',
            [
                'label'   => esc_html__('Description', 'priotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Enter your description', 'priotech'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            'heading_tag',
            [
                'label'   => esc_html__('Title HTML Tag', 'priotech'),
        ...
        $this->start_controls_section(
            'section_pricing',
            [
                'label' => esc_html__('Pricing', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            'currency_symbol',
            [
                'label'   => esc_html__('Currency Symbol', 'priotech'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''             => esc_html__('None', 'priotech'),
                    'dollar'       => '&#36; ' . _x('Dollar', 'Currency', 'priotech'),
                    'euro'         => '&#128; ' . _x('Euro', 'Currency', 'priotech'),
                    'baht'         => '&#3647; ' . _x('Baht', 'Currency', 'priotech'),
                    'franc'        => '&#8355; ' . _x('Franc', 'Currency', 'priotech'),
                    'guilder'      => '&fnof; ' . _x('Guilder', 'Currency', 'priotech'),
                    'krona'        => 'kr ' . _x('Krona', 'Currency', 'priotech'),
                    'lira'         => '&#8356; ' . _x('Lira', 'Currency', 'priotech'),
                    'peseta'       => '&#8359 ' . _x('Peseta', 'Currency', 'priotech'),
                    'peso'         => '&#8369; ' . _x('Peso', 'Currency', 'priotech'),
                    'pound'        => '&#163; ' . _x('Pound Sterling', 'Currency', 'priotech'),
                    'real'         => 'R$ ' . _x('Real', 'Currency', 'priotech'),
                    'ruble'        => '&#8381; ' . _x('Ruble', 'Currency', 'priotech'),
                    'rupee'        => '&#8360; ' . _x('Rupee', 'Currency', 'priotech'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency', 'priotech'),
                    'shekel'       => '&#8362; ' . _x('Shekel', 'Currency', 'priotech'),
                    'yen'          => '&#165; ' . _x('Yen/Yuan', 'Currency', 'priotech'),
                    'won'          => '&#8361; ' . _x('Won', 'Currency', 'priotech'),
                    'custom'       => esc_html__('Custom', 'priotech'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Custom Symbol', 'priotech'),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            'price',
            [
                'label'   => esc_html__('Price', 'priotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => '39.99',
                'dynamic' => [
                    'active' => true,
        ...
        $this->add_control(
            'currency_format',
            [
                'label'   => esc_html__('Currency Format', 'priotech'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''  => '1,234.56 (Default)',
                    ',' => '1.234,56',
        ...
        $this->add_control(
            'sale',
            [
                'label'     => esc_html__('Sale', 'priotech'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('On', 'priotech'),
                'label_off' => esc_html__('Off', 'priotech'),
                'default'   => '',
            ]
        );
        ...
        $this->add_control(
            'original_price',
            [
                'label'     => esc_html__('Original Price', 'priotech'),
         ...
         $this->add_control(
            'rood',
            [
                'label'   => esc_html__('Rood', 'priotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Sq/ft', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            'period',
            [
                'label'   => esc_html__('Period', 'priotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Monthly', 'priotech'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_features',
            [
                'label' => esc_html__('Features', 'priotech'),
            ]
        );
        ...
        $repeater->add_control(
            'item_text',
            [
                'label'   => esc_html__('Text', 'priotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('List Item', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'item_text'          => esc_html__('List Item #1', 'priotech'),
                        'selected_item_icon' => $default_icon,
                    ],
                    [
                        'item_text'          => esc_html__('List Item #2', 'priotech'),
                        'selected_item_icon' => $default_icon,
                    ],
                    [
                        'item_text'          => esc_html__('List Item #3', 'priotech'),
                        'selected_item_icon' => $default_icon,
                    ],
                ],
        ...
        $this->start_controls_section(
            'section_footer',
            [
                'label' => esc_html__('Footer', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Click Here', 'priotech'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            'button_icon_align',
            [
                'label'     => esc_html__('Icon Position', 'priotech'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'left',
                'options'   => [
                    'left'  => esc_html__('Before', 'priotech'),
                    'right' => esc_html__('After', 'priotech'),
                ],
                'condition' => [
                    'button_icon[value]!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Additional Info', 'priotech'),
                'type'    => Controls_Manager::TEXTAREA,
                'default' => esc_html__('This is text element', 'priotech'),
                'rows'    => 3,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->start_controls_section(
            'section_ribbon',
            [
                'label' => esc_html__('Ribbon', 'priotech'),
            ]
        );
        ...
        $this->add_control(
            'show_ribbon',
            [
                'label'     => esc_html__('Show', 'priotech'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Title', 'priotech'),
                'type'      => Controls_Manager::TEXT,
                'default'   => esc_html__('Popular', 'priotech'),
                'condition' => [
                    'show_ribbon' => 'yes',
                ],
                'dynamic'   => [
        ...
        $this->end_controls_section();
         ...
         $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Wrapper', 'priotech'),
         ...
         $this->add_control(
             'border_deco',
             [
                'label'     => esc_html__( 'Border Deco', 'priotech' ),
                'type'      => Controls_Manager::SWITCHER,
                'default' => '',
                'prefix_class'	=> 'priotech-border-deco-'
             ]
         );
         ...
         'border_hover_color',
             [
                 'label'     => esc_html__('Border Hover', 'priotech'),
                 'type'      => Controls_Manager::COLOR,
                 'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'before' => [
                        'title' => esc_html__('Before', 'priotech'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'after'  => [
                        'title' => esc_html__('After', 'priotech'),
                        'icon'  => 'eicon-h-align-right',
                    ],
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Fractional Part', 'priotech'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => false,
                'options'     => [
                    'below'  => esc_html__('Below', 'priotech'),
                    'beside' => esc_html__('Beside', 'priotech'),
                ],
                'default'     => 'below',
                'condition'   => [
                    'period!' => '',
        ...
        $this->add_control(
            ...
            [
                ...
                'options'   => [
                    ...
                    'solid'  => esc_html__('Solid', 'priotech'),
                    'double' => esc_html__('Double', 'priotech'),
                    'dotted' => esc_html__('Dotted', 'priotech'),
                    'dashed' => esc_html__('Dashed', 'priotech'),
                ],
                'default'   => 'solid',
                'condition' => [
                    'list_divider' => 'yes',
        ...
        $this->add_control(
            'divider_weight',
            [
                'label'     => esc_html__('Weight', 'priotech'),
                'type'      => Controls_Manager::SLIDER,
                'default'   => [
                    'size' => 2,
                    'unit' => 'px',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'md',
                'options'   => [
                    'xs' => esc_html__('Extra Small', 'priotech'),
                    'sm' => esc_html__('Small', 'priotech'),
                    'md' => esc_html__('Medium', 'priotech'),
                    'lg' => esc_html__('Large', 'priotech'),
                    'xl' => esc_html__('Extra Large', 'priotech'),
                ],
                'condition' => [
                    'button_text!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Animation', 'priotech'),
        ...
        $this->add_responsive_control(
            'ribbon_distance',
            [
                'label'     => esc_html__('Distance', 'priotech'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
...
$widgets_manager->register(new Priotech_Pricing());
