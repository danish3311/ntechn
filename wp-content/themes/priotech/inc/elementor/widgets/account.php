...
class Priotech_Elementor_Account extends Elementor\Widget_Base {

    public function get_name() {
        return 'priotech-accountsss';
    }

    public function get_title() {
        return esc_html__('Priotech Account', 'priotech');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'value'   => 'priotech-icon- priotech-icon-account',
                    'library' => 'priotech',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label'    => esc_html__('Content Name', 'priotech'),
        ...
        $this->add_control(
            'content_color',
            [
                'label'     => esc_html__('Color Content', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'name_text_color',
            [
                'label'     => esc_html__('Color Name', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Name Hover', 'priotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .site-header-account a:hover .account-content .content-content'  => 'color: {{VALUE}};',
...
$widgets_manager->register(new Priotech_Elementor_Account());
