 ...
 * @since 1.0.0
 */
class Priotech_Elementor_Image_Gallery extends Priotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Priotech Image Gallery', 'priotech');
    }
    ...
    public function get_script_depends() {
        return [
            'isotope',
            'masonry-pkgd',
            'priotech-elementor-image-gallery'
        ];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => esc_html__('Image Gallery', 'priotech'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => esc_html__('Filter Title', 'priotech'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('List Item', 'priotech'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => esc_html__('Add Images', 'priotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => esc_html__('Gallery 1', 'priotech'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    'masonry' => esc_html__('Masonry', 'priotech'),
                ],
                'prefix_class' => 'priotech-image-gallery-'
            ]
        );
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label'     => esc_html__('Filter Bar', 'priotech'),
...
//                    '(widescreen){{WRAPPER}} .grid__item'   => 'width: calc((100% - {{column_spacing.SIZE}}{{column_spacing.UNIT}}*({{column_widescreen.VALUE}} - 1)) / {{column_widescreen.VALUE}})',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .grid__item:nth-last-child(2n-2)' => 'margin-top: {{SIZE}}{{UNIT}}',
        ...
        $this->add_responsive_control(
            'filter_item_spacing',
            [
                'label'     => esc_html__('Space Between', 'priotech'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label'      => esc_html__('Filter Padding', 'priotech'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range'      => [
                    'px' => [
    ...
    protected function render() {
        ...
        if ($settings['show_filter_bar'] == 'yes') :
            ...
            <ul class="elementor-galerry__filters" data-related="isotope-<?php echo esc_attr($this->get_id()); ?>">
                <li class="elementor-galerry__filter elementor-active" data-filter=".gallery_group_all"><?php echo esc_html__('All', 'priotech'); ?>
...
$widgets_manager->register(new Priotech_Elementor_Image_Gallery());