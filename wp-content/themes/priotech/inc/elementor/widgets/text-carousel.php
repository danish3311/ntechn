 ...
 * @since 1.0.0
 */
class Priotech_Elementor_Text_Carousel extends Priotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Text Carousel', 'priotech');
    }
    ...
    public function get_script_depends() {
        return ['priotech-elementor-text-carousel'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Texts', 'priotech'),
            ]
        );
        ...
        $repeater->add_control(
            'text_cr_title',
            [
                'label'       => esc_html__('Text Item', 'priotech'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Text Item', 'priotech'),
                'placeholder' => esc_html__('Text Item', 'priotech'),
                'label_block' => true,
            ]
        );
...
$widgets_manager->register(new Priotech_Elementor_Text_Carousel());
