...
class Priotech_Elementor_Testimonials extends Priotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Priotech Testimonials', 'priotech');
    }
    ...
    public function get_script_depends() {
        return ['priotech-elementor-testimonial'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => esc_html__('Testimonials', 'priotech'),
            ]
        );
        ...
        $repeater->add_control(
            'testimonial_rating',
            [
                'label'   => esc_html__('Rating', 'priotech'),
                'default' => 5,
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    0 => esc_html__('Hidden', 'priotech'),
                    1 => esc_html__('Very poor', 'priotech'),
                    2 => esc_html__('Not that bad', 'priotech'),
                    3 => esc_html__('Average', 'priotech'),
                    4 => esc_html__('Good', 'priotech'),
                    5 => esc_html__('Perfect', 'priotech'),
                ]
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            'testimonial_job',
            [
                'label'   => esc_html__('Date', 'priotech'),
        ...
        $this->add_control(
            'icon-view',
            [
                'label'        => esc_html__('Icon-view', 'priotech'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'default' => esc_html__('Default', 'priotech'),
                    'stacked' => esc_html__('Stacked', 'priotech'),
                    'framed'  => esc_html__('Framed', 'priotech'),
                ],
                'default'      => 'default',
        ...
        $this->add_control(
            'shape',
            [
                'label'        => esc_html__('Shape', 'priotech'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'circle' => esc_html__('Circle', 'priotech'),
                    'square' => esc_html__('Square', 'priotech'),
                ],
                'default'      => 'circle',
                'condition'    => [
                    'icon-view!' => 'default',
        ...
        $this->add_control(
            'show_gradient',
            [
                'label'        => esc_html__('Show Gradient', 'priotech'),
                'type'         => Controls_Manager::SWITCHER,
                'prefix_class' => 'show-gradient-',
                'separator'    => 'before',
            ]
        );
         ...
         $this->add_responsive_control(
            'spacing_x',
            [
                'label'      => esc_html__('Horizontal Left', 'priotech'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'spacing_y',
            [
                'label'      => esc_html__('Horizontal Right', 'priotech'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'background_hover',
            [
                'label'     => esc_html__('Background Hover', 'priotech'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'       => esc_html__('Alignment Content', 'priotech'),
        ...
        $this->add_responsive_control(
            'align_caption',
            [
                'label'     => esc_html__('Alignment Info ', 'priotech'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'flex-start' => [
                        'title' => esc_html__('Left', 'priotech'),
        ...
        if ($testimonial['testimonial_rating'] && $testimonial['testimonial_rating'] > 0) {
            ...
            for ($i = 1; $i <= 5; $i++) {
                if ($i <= $testimonial['testimonial_rating']) {
                    echo '<i class="priotech-icon-star active" aria-hidden="true"></i>';
                }
            }
            echo '</div>';
        }
...
$widgets_manager->register(new Priotech_Elementor_Testimonials());
