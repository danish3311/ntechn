<?php
/**
 * Priotech WooCommerce Adjacent Products Class
 *
 * @package  aro
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Priotech_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Priotech WooCommerce Adjacent Products Class
	 */
	class Priotech_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'priotech_woocommerce_adjacent_query_args', $args ) );
