<?php
/**
 * Priotech_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Priotech_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Priotech_Product_Brand_List_Walker', false)) :

	class Priotech_Product_Brand_List_Walker extends Walker {
