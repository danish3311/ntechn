...
if (!class_exists('Priotech_WQFSP')) :

    class Priotech_WQFSP {
        ...
        /**
         * Main Priotech_WQFSP Instance
         *
         * Ensures only one instance of WooCommerce is loaded or can be loaded.
         *
         * @static
         * @return Priotech_WQFSP main instance
         * @see Priotech_WQFSP()
         */
