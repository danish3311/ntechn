    ...
    function quick_product_variable() {
        ...
        $(document).on('click', btnSelector, function (e) {
            ...
            if ($product.hasClass('quick-shop-loaded')) {
                ...
                $('body').trigger('priotech-quick-view-displayed');
                return;
            }
            ...
            $.ajax({
                url: priotechAjax.ajaxurl, data: {
                    action: 'priotech_quick_shop', id: id,
            ...
            // Ajax action.
            xhr = $.ajax({
                url: wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'priotech_add_to_cart'),
                data: formData,
                type: 'POST',
                processData: false,
                contentType: false,
